"""
Django settings for road_condition_detector project.
...
SECRET_KEY = 'wy(wv^rbg94ifemj=+)815q(nlwj$8wi@rxf1zf3r6%uvi5_*0'
...
ROOT_URLCONF = 'road_condition_detector.urls'
...
WSGI_APPLICATION = 'road_condition_detector.wsgi.application'
...
if 'VCAP_SERVICES' in os.environ:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'ad_010097681c9762f',
            'USER': 'b2cf2575600801', # bluemix
            'PASSWORD': '289f5c1b', # bluemix
            'HOST': 'us-cdbr-iron-east-02.cleardb.net', # bluemix
            'PORT': '3306', # bluemix
        }
    }
